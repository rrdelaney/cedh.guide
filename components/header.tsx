...
export function PageHeader() {
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center text-center bg-blue-700 text-white py-2 px-4 md:px-8 underline shadow-xl">
        This website is not associated with the CCC.
      </div>
    </>
  );
}
